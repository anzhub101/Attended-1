...
export const initialEvents: EventData[] = [
  ...
  },
  {
    ...
    description: 'Database Systems - Advanced SQL Queries',
    location: 'A-2F-13',
    start: { dateTime: '2025-07-21T05:00:00.000Z' },
    end: { dateTime: '2025-07-21T06:45:00.000Z' },
    color: '#4285F4',
  },
  {
    id: '2',
    ...
    description: 'Linear Algebra',
    location: 'H1-11-A',
    start: { dateTime: '2025-07-21T11:00:00.000Z' },
    end: { dateTime: '2025-07-21T12:40:00.000Z' },
    color: '#DB4437',
  },
  {
    id: '3',
    ...
    description: 'Physics II - Applications',
    location: 'D-0F-15',
    start: { dateTime: '2025-07-21T08:50:00.000Z' },
    end: { dateTime: '2025-07-21T10:20:00.000Z' },
    color: '#0F9D58',
  },
  {
    id: '4',
    ...
    description: 'Database Systems - Advanced SQL Queries',
    location: 'A-2F-13',
    start: { dateTime: '2025-07-23T05:00:00.000Z' },
    end: { dateTime: '2025-07-23T06:45:00.000Z' },
    color: '#4285F4',
  },
  {
    id: '5',
    ...
    description: 'Linear Algebra',
    location: 'H1-11-A',
    start: { dateTime: '2025-07-23T11:00:00.000Z' },
    end: { dateTime: '2025-07-23T12:40:00.000Z' },
    color: '#DB4437',
  },
  {
    id: '6',
    ...
    description: 'Physics II - Applications',
    location: 'D-0F-15',
    start: { dateTime: '2025-07-23T08:50:00.000Z' },
    end: { dateTime: '2025-07-23T10:20:00.000Z' },
    color: '#0F9D58',
  },
  {
    id: '7',
    ...
    description: 'Signals and Systems',
    location: 'D-0F-12',
    start: { dateTime: '2025-07-22T12:55:00.000Z' },
    end: { dateTime: '2025-07-22T14:20:00.000Z' },
    color: '#F4B400',
  },
  {
    id: '8',
    ...
    description: 'Innovation Entrepreneurship',
    location: 'A-1F-02',
    start: { dateTime: '2025-07-22T07:00:00.000Z' },
    end: { dateTime: '2025-07-22T08:45:00.000Z' },
    color: '#9C27B0',
  },
  {
    id: '9',
    ...
    description: 'Signals and Systems',
    location: 'D-0F-12',
    start: { dateTime: '2025-07-24T12:55:00.000Z' },
    end: { dateTime: '2025-07-24T14:20:00.000Z' },
    color: '#F4B400',
  },
  {
    id: '10',
    ...
    description: 'Innovation Entrepreneurship',
    location: 'A-1F-02',
    start: { dateTime: '2025-07-24T07:00:00.000Z' },
    end: { dateTime: '2025-07-24T08:45:00.000Z' },
    color: '#9C27B0',
  },
  {
    id: '11',
    ...
    description: 'Electric Circuits',
    location: 'Studio H101',
    start: { dateTime: '2025-07-25T05:00:00.000Z' },
    end: { dateTime: '2025-07-25T06:40:00.000Z' },
    color: '#3F51B5',
  },
  {
    id: '12',
    ...
    description: 'Electric Circuits',
    location: 'Studio H101',
    start: { dateTime: '2025-07-25T06:50:00.000Z' },
    end: { dateTime: '2025-07-25T08:30:00.000Z' },
    color: '#3F51B5',
  },
];
