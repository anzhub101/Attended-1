...
export const initialEvents: EventData[] = [
  {
    ...
    location: 'A-2F-13',
    start: { dateTime: '2025-08-25T05:00:00.000Z' },
    end: { dateTime: '2025-08-25T06:45:00.000Z' },
    color: '#4285F4',
  },
  {
    id: '2',
    ...
    location: 'H1-11-A',
    start: { dateTime: '2025-08-25T11:00:00.000Z' },
    end: { dateTime: '2025-08-25T12:40:00.000Z' },
    color: '#DB4437',
  },
  {
    id: '3',
    ...
    location: 'D-0F-15',
    start: { dateTime: '2025-08-25T08:50:00.000Z' },
    end: { dateTime: '2025-08-25T10:20:00.000Z' },
    color: '#0F9D58',
  },
  {
    id: '4',
    ...
    description: 'Database Systems - Advanced SQL Queries',
    location: 'A-2F-13',
    start: { dateTime: '2025-08-27T05:00:00.000Z' },
    end: { dateTime: '2025-08-27T06:45:00.000Z' },
    color: '#4285F4',
  },
  {
    id: '5',
    ...
    description: 'Linear Algebra',
    location: 'H1-11-A',
    start: { dateTime: '2025-08-27T11:00:00.000Z' },
    end: { dateTime: '2025-08-27T12:40:00.000Z' },
    color: '#DB4437',
  },
  {
    id: '6',
    ...
    description: 'Physics II - Applications',
    location: 'D-0F-15',
    start: { dateTime: '2025-08-27T08:50:00.000Z' },
    end: { dateTime: '2025-08-27T10:20:00.000Z' },
    color: '#0F9D58',
  },
  {
    id: '7',
    ...
    location: 'D-0F-12',
    start: { dateTime: '2025-08-26T12:55:00.000Z' },
    end: { dateTime: '2025-08-26T14:20:00.000Z' },
    color: '#F4B400',
  },
  {
    id: '8',
    ...
    location: 'A-1F-02',
    start: { dateTime: '2025-08-26T07:00:00.000Z' },
    end: { dateTime: '2025-08-26T08:45:00.000Z' },
    color: '#9C27B0',
  },  
  {
    id: '9',
    ...
    description: 'Signals and Systems',
    location: 'D-0F-12',
    start: { dateTime: '2025-08-28T12:55:00.000Z' },
    end: { dateTime: '2025-08-28T14:20:00.000Z' },
    color: '#F4B400',
  },
  {
    id: '10',
    ...
    description: 'Innovation Entrepreneurship',
    location: 'A-1F-02',
    start: { dateTime: '2025-08-28T07:00:00.000Z' },
    end: { dateTime: '2025-08-28T08:45:00.000Z' },
    color: '#9C27B0',
  },
  {
    id: '11',
    ...
    start: { dateTime: '2025-08-29T05:00:00.000Z' },
    end: { dateTime: '2025-08-29T06:40:00.000Z' },
    color: '#3F51B5',
  },
  {
    id: '12',
    ...
    description: 'Electric Circuits',
    location: 'Studio H101',
    start: { dateTime: '2025-08-29T06:50:00.000Z' },
    end: { dateTime: '2025-08-29T08:30:00.000Z' },
    color: '#3F51B5',
  },

  // --- extra shifted weeks (second batch) ---

  {
    ...
    description: 'Database Systems - Advanced SQL Queries',
    location: 'A-2F-13',
    start: { dateTime: '2025-09-01T05:00:00.000Z' },
    end: { dateTime: '2025-09-01T06:45:00.000Z' },
    color: '#4285F4',
  },
  {
    id: '2',
    ...
    description: 'Linear Algebra',
    location: 'H1-11-A',
    start: { dateTime: '2025-09-01T11:00:00.000Z' },
    end: { dateTime: '2025-09-01T12:40:00.000Z' },
    color: '#DB4437',
  },
  {
    id: '3',
    ...
    description: 'Physics II - Applications',
    location: 'D-0F-15',
    start: { dateTime: '2025-09-01T08:50:00.000Z' },
    end: { dateTime: '2025-09-01T10:20:00.000Z' },
    color: '#0F9D58',
  },
  {
    id: '4',
    ...
    description: 'Database Systems - Advanced SQL Queries',
    location: 'A-2F-13',
    start: { dateTime: '2025-09-03T05:00:00.000Z' },
    end: { dateTime: '2025-09-03T06:45:00.000Z' },
    color: '#4285F4',
  },
  {
    id: '5',
    ...
    description: 'Linear Algebra',
    location: 'H1-11-A',
    start: { dateTime: '2025-09-03T11:00:00.000Z' },
    end: { dateTime: '2025-09-03T12:40:00.000Z' },
    color: '#DB4437',
  },
  {
    id: '6',
    ...
    description: 'Physics II - Applications',
    location: 'D-0F-15',
    start: { dateTime: '2025-09-03T08:50:00.000Z' },
    end: { dateTime: '2025-09-03T10:20:00.000Z' },
    color: '#0F9D58',
  },
  {
    id: '7',
    ...
    description: 'Signals and Systems',
    location: 'D-0F-12',
    start: { dateTime: '2025-09-02T12:55:00.000Z' },
    end: { dateTime: '2025-09-02T14:20:00.000Z' },
    color: '#F4B400',
  },
  {
    id: '8',
    ...
    description: 'Innovation Entrepreneurship',
    location: 'A-1F-02',
    start: { dateTime: '2025-09-02T07:00:00.000Z' },
    end: { dateTime: '2025-09-02T08:45:00.000Z' },
    color: '#9C27B0',
  },
  {
    id: '9',
    ...
    description: 'Signals and Systems',
    location: 'D-0F-12',
    start: { dateTime: '2025-09-04T12:55:00.000Z' },
    end: { dateTime: '2025-09-04T14:20:00.000Z' },
    color: '#F4B400',
  },
  {
    id: '10',
    ...
    description: 'Innovation Entrepreneurship',
    location: 'A-1F-02',
    start: { dateTime: '2025-09-04T07:00:00.000Z' },
    end: { dateTime: '2025-09-04T08:45:00.000Z' },
    color: '#9C27B0',
  },
  {
    id: '11',
    ...
    description: 'Electric Circuits',
    location: 'Studio H101',
    start: { dateTime: '2025-09-05T05:00:00.000Z' },
    end: { dateTime: '2025-09-05T06:40:00.000Z' },
    color: '#3F51B5',
  },
  {
    id: '12',
    ...
    description: 'Electric Circuits',
    location: 'Studio H101',
    start: { dateTime: '2025-09-05T06:50:00.000Z' },
    end: { dateTime: '2025-09-05T08:30:00.000Z' },
    color: '#3F51B5',
  },

  // --- Random assignment deadlines ---
  {
    id: 'A1',
    ...
    location: 'Online',
    start: { dateTime: '2025-08-30T23:58:00.000Z' },
    end: { dateTime: '2025-08-30T23:59:00.000Z' },
    color: '#FF5722',
  },
  {
    id: 'A2',
    ...
    description: 'Assignment deadline',
    location: 'Online',
    start: { dateTime: '2025-09-06T23:58:00.000Z' },
    end: { dateTime: '2025-09-06T23:59:00.000Z' },
    color: '#FF5722',
  },
  {
    id: 'A3',
    ...
    description: 'Assignment deadline',
    location: 'Online',
    start: { dateTime: '2025-09-10T23:58:00.000Z' },
    end: { dateTime: '2025-09-10T23:59:00.000Z' },
    color: '#FF5722',
  }
];
