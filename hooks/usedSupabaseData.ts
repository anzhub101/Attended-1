...
const mockEvents = [
  {
    ...
    location: 'A-2F-13',
    start_time: '2025-01-27T05:00:00.000Z',
    end_time: '2025-01-27T06:45:00.000Z',
    color: '#4285F4',
    category: 'academic',
  ...
  },
  {
    ...
    location: 'H1-11-A',
    start_time: '2025-01-27T11:00:00.000Z',
    end_time: '2025-01-27T12:40:00.000Z',
    color: '#DB4437',
    category: 'academic',
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    location: 'D-0F-15',
    start_time: '2025-01-27T08:50:00.000Z',
    end_time: '2025-01-27T10:20:00.000Z',
    color: '#0F9D58',
    category: 'academic',
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
...
const mockCampusEvents = [
  {
    ...
    description: 'Join us for an exciting week of activities...',
    location: 'Main Auditorium',
    event_date: '2025-09-02T05:00:00Z',
    event_time: '09:00 AM',
    start: { dateTime: '2025-09-02T12:00:00Z'}, // 10 AM GST = 6 AM UTC
    end: {dateTime: '2025-09-02T13:00:00Z'},   // 12 PM GST = 8 AM UTC
  ...
  },
  {
    ...
    event_time: '9:00 AM',
    start_time: '2025-09-09T05:00:00Z', // 9 AM GST = 5 AM UTC
    end_time: '2025-09-09T07:00:00Z',   // 11 AM GST = 7 AM UTC
    registration_required: true,
    max_attendees: 1000,
  ...
  },
  {
    ...
    event_date: '2025-09-16T00:00:00Z',
    event_time: '2:00 PM',
    start_time: '2025-09-16T10:00:00Z', // 2 PM GST = 10 AM UTC
    end_time: '2025-09-16T12:00:00Z',   // 4 PM GST = 12 PM UTC
    registration_required: true,
    max_attendees: 100,
